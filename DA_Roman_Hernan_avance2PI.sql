...
-- desactivar las resticciones de la clave alterna
ALTER TABLE DetalleOrdenes
NOCHECK CONSTRAINT FK__DetalleOr__Produ__6477ECF3;

DELETE FROM Productos WHERE CategoriaID = 2;

-- volver a activar las restricciones de clave externa
ALTER TABLE DetalleOrdenes
CHECK CONSTRAINT FK__DetalleOr__Produ__6477ECF3;
...
hay ordenes que incluyen este producto pero solo quiero eliminar el producto porque no se va a vender mas, pero si quiero seguir manteniendo
las ordenes donde se vendieron esos productos para su posterior analisis
*/
Select * from Productos;
...
-- cuantos poductos diferentes hay en el orden 1
select OrdenID, 
...
/* consulta 5 ¿Cuáles son las sucursales con un promedio de ventas por orden superior a un valor 
específico (40), ordenadas por el promedio de kilómetros recorridos para las entregas de mayor a menor?
*/
select SucursalID,
